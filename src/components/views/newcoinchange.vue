            ...
            <el-row>
              <el-col :span="12" style="margin-bottom: 10px">
                <el-form-item label="真实姓名:" :label-width="formLabelWidth">
                  <el-input :style="styleObject" :value="message.userName" :disabled="true" auto-complete="off" style=""
                            clearable></el-input>
                </el-form-item>
              </el-col>
              <el-col v-if="message.changedType==3" :span="12" style="margin-bottom: 10px">
                <el-form-item label="支付宝账号:" :label-width="formLabelWidth">
                  <el-input :style="styleObject" :value="message.aliNum" :disabled="true" auto-complete="off" style=""
                            clearable></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12" style="margin-bottom: 10px">
                <el-form-item label="金币变动:" :label-width="formLabelWidth">
                  <el-input :style="styleObject" :value="message.amount | currency" :disabled="true" auto-complete="off"
              ...
              <el-col :span="12" style="margin-bottom: 10px">
                <el-form-item label="变更时间:" :label-width="formLabelWidth">
                  <el-input :style="styleObject" :value="message.changedTime" :disabled="true" auto-complete="off"
                            style="" clearable></el-input>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12" v-if="message.changedType==3" style="margin-bottom: 10px">
                <el-form-item label="审核时间:" :label-width="formLabelWidth">
                  <el-input :style="styleObject" :value="message.auditTime" :disabled="true" auto-complete="off"
                            style="" clearable></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12" v-if="message.changedType==3" style="margin-bottom: 10px">
                <el-form-item label="审核结果:" :label-width="formLabelWidth">
                  <el-select :style="styleObject" v-model="message.status" :disabled="true"
                             @change="isAuditingChange(messageForm.status)" placeholder="">
              ...
              <el-col v-if="reasonMess" :span="20" style="margin-bottom: 10px">
                <el-form-item label="拒绝原因:" :label-width="formLabelWidth">
                  <el-input :rows="4" spellcheck="false" :disabled="true" type="textarea" v-model="message.reason"
                            auto-complete="off" style="" clearable></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
        ...
        <el-dialog title="审核" :visible.sync="dialogTableVisible" width="800px">
          <el-form>
            <el-row>
              <el-col :span="12" style="margin-bottom: 10px">
                <el-form-item label="真实姓名:" :label-width="formLabelWidth">
                  <el-input :style="styleObject" :value="messageForm.userName" :disabled="true" auto-complete="off"
                            style="" clearable></el-input>
                </el-form-item>
              </el-col>
              <el-col v-if="messageForm.changedType==3" :span="10" style="margin-bottom: 10px">
                <el-form-item label="支付宝账号:" :label-width="formLabelWidth">
                  <el-input :style="styleObject" :value="messageForm.account" :disabled="true" auto-complete="off"
                            style="" clearable></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12" style="margin-bottom: 10px">
                <el-form-item label="提现金额（元）:" :label-width="formLabelWidth">
                  <el-input :style="styleObject" :value="messageForm.amountM" :disabled="true" auto-complete="off"
                            style="" clearable></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12" style="margin-bottom: 10px">
                <el-form-item label="金币余额:" :label-width="formLabelWidth">
                  <el-input :style="styleObject" :value="messageForm.coin | currency" :disabled="true"
                            auto-complete="off" style="" clearable></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12" style="margin-bottom: 10px">
                <el-form-item label="金币变动:" :label-width="formLabelWidth">
                  <el-input :style="styleObject" :value="messageForm.amount | currency" :disabled="true"
                            auto-complete="off" style="" clearable></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12" style="margin-bottom: 10px">
              ...
              <el-col :span="12" style="margin-bottom: 10px">
                <el-form-item label="变更时间:" :label-width="formLabelWidth">
                  <el-input :style="styleObject" :value="messageForm.changedTime" :disabled="true" auto-complete="off"
                            style="" clearable></el-input>
                </el-form-item>
              </el-col>
              <!--<el-col :span="12" style="margin-bottom: 10px">-->
              ...
              <el-col :span="12" style="margin-bottom: 10px">
                <el-form-item label="审核结果:" :label-width="formLabelWidth">
                  <el-select :style="styleObject" v-model="messageForm.status"
                             @change="isAuditingChange(messageForm.status)" placeholder="">
                    <el-option label="正常" :value="1"></el-option>
                    <el-option label="冻结" :value="2"></el-option>
                    <el-option label="拒绝" :value="3"></el-option>
              ...
              <el-col v-if="reasonMess" :span="20" style="margin-bottom: 10px">
                <el-form-item label="拒绝原因:" :label-width="formLabelWidth">
                  <el-input :rows="4" spellcheck="false" type="textarea" v-model="messageForm.reason"
                            auto-complete="off" style="" clearable></el-input>
                </el-form-item>
              </el-col>
            </el-row>
