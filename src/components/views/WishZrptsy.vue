    ...
    <div class="administratormanage-inner">
      ...
      <div>
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          <el-form-item label="昨日日期:">
            <el-date-picker
            @change="timePickeTap"
              v-model="formInline.yesterDate"
              align="right"
              type="date"
              placeholder="选择日期"
      ...
      <div class="administratormanage-table">
        <template>
          <el-table :data="tableData" height="580">
            ...
            <el-table-column prop="rateXyx" label="幸运星分红比例">
            </el-table-column>
        ...
        <el-dialog title="添加" :visible.sync="dialogFormVisible" width="800px">
          <el-form :model="form" :rules="rules" ref="form">
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="分红心分红比例" :label-width="formLabelWidth" prop="rateFhx">
                  <el-input v-model="form.rateFhx" auto-complete="off" style="width: 200px" clearable>
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="幸运星分红比例" :label-width="formLabelWidth" prop="rateXyx">
                  <el-input v-model="form.rateXyx" auto-complete="off" style="width: 200px" clearable>
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
        ...
        <el-dialog title="修改" :visible.sync="dialogTableVisible" width="800px">
          ...
          <el-form :model="formtwo">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="分红心分红比例" :label-width="formLabelWidth" prop="rateFhx">
                  <el-input v-model="formtwo.rateFhx" auto-complete="off" style="width: 200px" clearable>
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="幸运星分红比例" :label-width="formLabelWidth" prop="rateXyx">
                  <el-input v-model="formtwo.rateXyx" auto-complete="off" style="width: 200px" clearable>
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
...
<script type="text/javascript">
  ...
  export default {
    ...
    methods: {
      ...
      accountList() {
        // this.formInline.yesterDate = formatDate(new Date(this.formInline.yesterDate), 'yyyy-MM-dd');
        let parameterData = {
          pageNum: this.currentPage,
          pageSize: this.pageSize,
          yesterDate: this.formInline.yesterDate
        }
        this.$fetch('/wish/platformIncome/list', parameterData).then(res => {
          if ((res.statusCode+"").startsWith("2")) {
      ...
      addBtn(form) {
        this.$refs[form].validate(valid => {
          if(valid) {
            this.form.yesterDate = formatDate(new Date(this.form.yesterDate), 'yyyy-MM-dd');
            this.$post('/wish/platformIncome/add', this.form).then(res => {
              if ((res.statusCode+"").startsWith("2")) {
      ...
      delData(id) {
        ...
        this.$post('/wish/platformIncome/remove', parameterData).then(res => {
          if ((res.statusCode+"").startsWith("2")) {
            this.$message({
              type: 'success',
              message: '删除成功！'
      ...
      getInfo(id) {
        ...
        this.$fetch('/wish/platformIncome/info', {
          id: id
        }).then(res => {
          if ((res.statusCode+"").startsWith("2")) {
      ...
      update(formtwo) {
        this.$put('/wish/platformIncome/modify', this.formtwo).then(res => {
          if ((res.statusCode+"").startsWith("2")) {
            this.$message({
              type: 'success',
              message: '修改成功！'
      ...
      //时间查询
      timePickeTap(){
        if (this.formInline.yesterDate){
          let times = this.formInline.yesterDate;
          this.formInline.yesterDate = formatDate(new Date(times), 'yyyy-MM-dd');
        }else {
          this.formInline.yesterDate = ''
        }
      },
    },
  }
