  ...
  <div class="administratormanage-wrap">
    <div class="administratormanage-inner">
      <div class="administratormanage-header">
        <h3>历史数据/金币账变明细<span class="child-title">  (今天早晨4点之前数据)</span> </h3>
        <hr />
      </div>
      <div>
  ...
  export default {
    ...
    methods: {
      ...
      accountList() {
        ...
        this.$fetch('/simple/lCoinChange/page', parameterData).then(res => {
          if ((res.statusCode+"").startsWith("2")) {
      ...
      getInfo(id) {
        ...
        this.$fetch('/simple/lCoinChange/info', {
          id: id
        }).then(res => {
          if ((res.statusCode+"").startsWith("2")) {
      ...
      getAuditingInfo(id){
        ...
        this.$fetch('/simple/lCoinChange/queryWithdrawalsInfo', {
          id: id
        }).then(res => {
          if ((res.statusCode+"").startsWith("2")) {
            if(res.data.status==3){
      ...
      update(messageForm) {
        ...
        this.$fetch('/simple/lCoinChange/audit', parameterData).then(res => {
          if ((res.statusCode+"").startsWith("2")) {
            this.$message({
              type: 'success',
              message: '修改成功！'
