      ...
      <div class="vip-manage-table">
        <template>
          <el-table :data="tableData" style="width: 100%" max-height="600">
            <el-table-column label="用户id" prop="account_id" width='300'>
            </el-table-column>
            <el-table-column label="转换金额" prop="change_amount" width='300'>
            </el-table-column>
            <el-table-column :formatter="dateFormat" label="导入钱包时间" prop="create_time" width='300'>
            </el-table-column>
          </el-table>
        </template>
  ...
  export default {
    ...
    methods: {
      ...
      dataList() {
        ...
        this.$fetch('/py/checkpointincomechange/list', parameterData).then(res => {
          if (res) {
