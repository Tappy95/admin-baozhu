<template>
  <div class="ip-black-wrap">
    <div class="ip-black-inner">
      <div class="ip-black-header">
        <h3>系统配置/ip黑名单</h3>
        <hr />
      </div>
      <div>
      ...
      <div class="ip-black-table">
        ...
        <el-dialog title="添加Ip黑名单" :visible.sync="dialogFormVisible" width="600px">
