  ...
  export default {
    ...
    methods: {
      ...
      accountList() {
        ...
        this.$fetch('/wish/guessRewardRate/list', parameterData).then(res => {
          if ((res.statusCode+"").startsWith("2")) {
      ...
      addBtn(form) {
        this.$refs[form].validate(valid => {
          if(valid) {
            this.$post('/wish/guessRewardRate/add', this.form).then(res => {
              if ((res.statusCode+"").startsWith("2")) {
      ...
      delData(id) {
        ...
        this.$post('/wish/guessRewardRate/remove', parameterData).then(res => {
          if ((res.statusCode+"").startsWith("2")) {
            this.$message({
              type: 'success',
              message: '删除成功！'
      ...
      getInfo(id) {
        ...
        this.$fetch('/wish/guessRewardRate/info', {
          id: id
        }).then(res => {
          if ((res.statusCode+"").startsWith("2")) {
      ...
      update(formtwo) {
        this.$put('/wish/guessRewardRate/modify', this.formtwo).then(res => {
          if ((res.statusCode+"").startsWith("2")) {
            this.$message({
              type: 'success',
              message: '修改成功！'
